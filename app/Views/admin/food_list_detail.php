        ...
        <div class="container-fluid">
            ...
            <div class="row bg-white">
                <div class="col p-4" style="box-sizing: border-box;box-shadow: 0px 1px 0px rgba(17,17,26,0.1); border-top : 2px solid blue">
                    ...
                    <?= form_open('admin/food_list_edit', [
                    ...
                    <input class='form-control' type="text" name="food_name" id="food_name" value="<?= $row['food_name']; ?>" required><br>
                    <label class="form-label" for="food_name">Harga : </label>
                    <input class='form-control' type="text" name="food_price" id="food_price" value="<?= $row['food_price']; ?>" required><br>
                    <label class="form-label" for="food_name">Berkas Gambar : </label>
                    <input class='form-control' type="file" name="food_img" id="food_img" onchange="readURL(this);"><br>
