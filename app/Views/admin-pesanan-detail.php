                            ...
                            <div class="col p-4" style="box-sizing: border-box;box-shadow: 0px 1px 0px rgba(17,17,26,0.1); border-top : 2px solid blue">
                                <table class="table">
                                    <tr>
                                        <th>terhidang?</th>
                                        <th>:</th>
                                        <th><span class="badge <?php echo $items->getResult()[0]->is_served == 'n' ? 'bg-danger' : 'bg-success'  ?> text-white"><?php echo $items->getResult()[0]->is_served == 'n' ? 'belum' : 'sudah'  ?></span></th>
                                    </tr>
                                    <tr>
                                        <th>username</th>
                                        <th>:</th>
                                        <th><?= $items->getResult()[0]->username ?></th>
                                    </tr>
                                    <tr>
                                        <th>nomer meja</th>
                                        <th>:</th>
                                        <th><?= $items->getResult()[0]->nomeja ?></th>
                                    </tr>
                                    <tr>
                                        <th>total bayar</th>
                                        <th>:</th>
                                        <th >Rp. <?= number_format($items->getResult()[0]->total_harga) ?></th>
                                    </tr>
                                    <tr>
                                        <th>Menu</th>
                                        <th>Gambar</th>
                                    ...
                                    <?php foreach ($items->getResult() as $item) { ?>
                                        <tr>
                                            ...
                                            <td><?= $item->name ?></td>
                                            <td style="width : 15%"><img style="width : 100%" src="/images/<?= $item->image ?>" /></td>
                                            <td><?= $item->jumlah ?></td>
